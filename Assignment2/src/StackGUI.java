...
public class StackGUI extends JPanel {
	...
	public StackGUI()
	{
		...
		lblAuthor = new JLabel("This program was written by Germain Matali.");
	...
	private class CompleteListener implements ActionListener
	{
		public void actionPerformed(ActionEvent event)
		{
			...
			strLength = text.length();
				...
				// was read in and push each character
				// onto the stack
			...
			{		
				...
				{
					JOptionPane.showMessageDialog(null, 
						"Cant push the characters" 
						+ text.charAt(i) + "onto the stack!",
						"ERROR",
						JOptionPane.ERROR_MESSAGE);
				}  //end for loop
				else // there is room to push 
			...
			output = "";
				...
				// stack and build a string (backwards)
			while (myStack.notEmpty())
			{
				oneChar	= myStack.pop();
				output 	= output + oneChar;
			}	// end while loop
				//place this reversed string
				// into out text field for display 
